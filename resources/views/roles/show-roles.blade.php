...
<div class="max-w-4xl mx-auto mt-12 bg-white rounded-2xl shadow-md p-8">
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ url('roles/' . $role->role_id . '/edit') }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-50 p-4 rounded-xl shadow-sm">
            <h3 class="text-sm font-semibold text-gray-500 uppercase">Role Name</h3>
            <p class="mt-1 text-lg text-gray-900 font-semibold">{{ $role->role_name ?? '-' }}</p>
        </div>

        {{-- Code --}}
        <div class="bg-gray-50 p-4 rounded-xl shadow-sm">
            <h3 class="text-sm font-semibold text-gray-500 uppercase">Code</h3>
            <p class="mt-1 text-lg text-gray-900 font-semibold">{{ $role->code ?? '-' }}</p>
        </div>
        ...
        <div class="bg-gray-50 p-4 rounded-xl shadow-sm sm:col-span-2">
            ...
            <p class="mt-1 text-gray-800 whitespace-pre-line">{{ $role->description ?? '-' }}</p>
        </div>
